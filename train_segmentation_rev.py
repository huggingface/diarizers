...
from diarizers import Preprocess, SegmentationModel,  DataCollator, Metrics, SpeakerDiarizationDataset
...
def read_rev_dir(dirpath: str):
    audio_files = sorted(glob.glob(f'{dirpath}/*.wav'))
    rttm_files = sorted(glob.glob(f'{dirpath}/*.rttm'))
...
if __name__ == "__main__":
    ...
    train_audio_files, train_rttm_files = read_rev_dir(data_args.dataset_train)

    dev_audio_files, dev_rttm_files = read_rev_dir(data_args.dataset_dev)
